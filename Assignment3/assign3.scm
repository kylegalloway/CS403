...
; Task 1
(include "tasks/task1.scm")

; Task 2
(include "tasks/task2.scm")

; Task 3
(include "tasks/task3.scm")

; Task 4
(include "tasks/task4.scm")

; Task 5
(include "tasks/task5.scm")

; Task 6
(include "tasks/task6.scm")

; Task 7
(include "tasks/task7.scm")

; Task 8
(include "tasks/task8.scm")

; Task 9
(include "tasks/task9.scm")
