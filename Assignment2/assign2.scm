...
(define (big+ a b)
    ...
    (if (== (car a) '-)
        (if (== (car b) '-)
            (reverse (iter (reverse (cdr a)) (reverse (cdr b)) nil 0))
            (reverse (append (iter (reverse (cdr a)) (reverse b) nil 0) '(-)))
        )
        (if (== (car b) '-)
            (reverse (append (iter (reverse a) (reverse (cdr b)) nil 0) '(-)))
...
(define (big- a b)
    ...
    (cond
        ...
        (((and (== (car a) '-) (== (car b) '-)))
            (reverse (iter (reverse (cdr a)) (reverse b)))
        )
        (((and (!= (car a) '-) (!= (car b) '-)))
            (reverse (iter (reverse a) (reverse b)))
        )
